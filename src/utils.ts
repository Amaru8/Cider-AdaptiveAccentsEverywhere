 ...
 */
export async function getAlbumMediaItem(id: string): Promise<MusicKit.MediaItem> {
    try {
        let albumId = id;
        ...
        endpoint = isLibraryItem ? `/v1/me/library/albums/${albumId}` : `/v1/catalog/${storefrontId}/albums/${albumId}`;
